...
void LevelB::initialise()
{
    ...
    m_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVELB_DATA, map_texture_id, 1.0f, 13, 8);
    ...
    m_state.player->set_position(glm::vec3(0.5f, 0.0f, 0.0f));
    ...
    /**
     Enemies' stuff */
    GLuint enemy_texture_id = Utility::load_texture("/Users/chelsea/Desktop/Final 2/SDLProject/assets/challenger_sprite_meadow.png");
    
    m_state.enemies = new Entity[ENEMY_COUNT];
    m_state.enemies[0].set_entity_type(ENEMY);
    m_state.enemies[0].set_ai_type(WALKER);
//    m_state.enemies[0].set_ai_state(SQUARE);
    m_state.enemies[0].m_texture_id = enemy_texture_id;
    m_state.enemies[0].set_position(glm::vec3(11.9f, -6.2f, 0.0f));
    ...
    m_state.enemies[0].m_animation_indices =  m_state.enemies[0].m_walking[m_state.enemies[0].LEFT];  // start Challenger 3 looking LEFT
