...
enum EntityType { PLATFORM, PLAYER, ENEMY, OBJECT, TEXTBOX};
enum AIType     { WALKER, GUARD, JUMPER, STANDING};
enum AIState    { WALKING, IDLE, ATTACKING, SQUARE};
...
public:
    // Static attributes
    static const int SECONDS_PER_FRAME = 5;
...
//    bool challenger_defeated = false;
    ...
    void ai_standing(Entity *player);
    ...
    void const set_death_count(int new_death_count)         { m_death_count  = new_death_count;      };
